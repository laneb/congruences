...
congruences_test: congruences.c test/congruences_test.c arith_utils.c prime_gen.c
	gcc -g prime_gen.c arith_utils.c congruences.c test/congruences_test.c -o congruences_test

arith_utils_test: arith_utils.c test/arith_utils_test.c prime_gen.c
	gcc -g prime_gen.c arith_utils.c test/arith_utils_test.c -o arith_utils_test

prime_gen_test: prime_gen.c test/prime_gen_test.c
